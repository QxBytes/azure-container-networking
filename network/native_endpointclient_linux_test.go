	...
	tests := []struct {
		...
		// Populating VM with data and creating interfaces/links
		{
			...
			client: &NativeEndpointClient{
				...
				vnetNSName:        "az_ns_1",
				netnsClient:       netns.NewMock(2, "no such file or directory"),
		...
		},
		{
			...
			client: &NativeEndpointClient{
				...
				containerVethName: "B1veth0",
				vnetNSName:        "az_ns_1",
				netnsClient:       netns.NewMock(1, "netns failure"),
				netlink:           netlink.NewMockNetlink(false, ""),
				plClient:          platform.NewMockExecClient(false),
				netUtilsClient:    networkutils.NewNetworkUtils(nl, plc),
				netioshim:         netio.NewMockNetIO(false, 0),
		...
		},
		{
			...
			client: &NativeEndpointClient{
				...
				containerVethName: "B1veth0",
				vnetNSName:        "az_ns_1",
				netnsClient:       netns.NewMock(2, "netns failure"),
				netlink:           netlink.NewMockNetlink(false, ""),
				plClient:          platform.NewMockExecClient(false),
				netUtilsClient:    networkutils.NewNetworkUtils(nl, plc),
				netioshim:         netio.NewMockNetIO(false, 0),
		...
		},
		{
			...
			client: &NativeEndpointClient{
				...
				containerVethName: "B1veth0",
				vnetNSName:        "az_ns_1",
				netnsClient:       netns.NewMock(3, "netns failure"),
				netlink:           netlink.NewMockNetlink(false, ""),
				plClient:          platform.NewMockExecClient(false),
				netUtilsClient:    networkutils.NewNetworkUtils(nl, plc),
				netioshim:         netio.NewMockNetIO(false, 0),
	...
	tests := []struct {
		...
		// You must have <= 2 ip routes on your machine for this to pass
		{
			...
			client: &NativeEndpointClient{
				...
				containerVethName: "B1veth0",
				vnetNSName:        "az_ns_1",
				netnsClient:       netns.NewMock(5, "netns failure"),
				netlink:           netlink.NewMockNetlink(false, ""),
				plClient:          platform.NewMockExecClient(false),
				netUtilsClient:    networkutils.NewNetworkUtils(nl, plc),
				netioshim:         netio.NewMockNetIO(false, 0),
